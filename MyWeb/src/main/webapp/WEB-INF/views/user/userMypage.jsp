            ...
            <div class="row">
                <div class="col-sm-12 col-md-10 col-lg-9 myInfo">
                    ...
                    <div class="tab-content">
                            ...
                            <table class="table">
                                <tbody class="m-control">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control input-sm add" id="addrDatail" name="addrDetail" value="${userInfo.addrDetail }" readonly ></td>
                                    </tr>
                                </tbody>
                            </table>
                            </form>
                        ...
                        <!-- 두번째 토글시작 -->
                        <!-- user, freeboard 테이블 결합해서 DB 가져와야한다.  'Join' -->
	...
	$(function() {
        ...
        */
		...
		$('#updateBtn').click(function() {
			...
			//비밀번호 검증
			if ($('#userPw').val()===''	||		$('#userPwChk').val() !== $('#userPw').val()) {
		...
		//다음주소api를 수정페이지에서도 똑같이 사용할 수 있도록 이벤트처리
